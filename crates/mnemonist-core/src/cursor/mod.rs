//! Cursor semantics, ported from `obliterator` v2.0.5 `docs/DIVERGENCES.md`'s iteration section, 3.6, 3.7).
//!
...
//! [`Step::Done`]. That is DIV-SPARSE-SET-1 / `docs/DIVERGENCES.md`'s iteration section Option A.
//!
...
/// divergence `docs/DIVERGENCES.md`'s iteration section rejected.
