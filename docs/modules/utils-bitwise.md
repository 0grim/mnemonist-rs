...
`crates/mnemonist-core/src/utils/bitwise.rs` — 14 tests, closing every gap above: a 252-point
cross-product against real Node 24.18.1 (see below), both popcount implementations checked against
